...
export function RegisterSidePanel() {
  return (
    <div className="hidden md:flex items-center justify-center bg-gradient-to-br from-[#433A9B] to-[#5a4fb8] p-12 relative overflow-hidden">
      <div className="absolute inset-0 bg-grid-white/[0.05] bg-[size:20px_20px]" />
      <div className="relative z-10 text-white max-w-md">
        <Factory className="w-20 h-20 mb-6 text-[#F39A3D]" />
