...
function HeroStat({ label, value, hint }) {
  return (
    <div className="rounded-lg bg-white/10 p-4 backdrop-blur-sm">
      ...
      {hint && <p className="text-xs text-[#F3D33B]">{hint}</p>}
    </div>
  );
}

export function HeroSection({ summary = {}, onNavigate }) {
  return (
    <Card className="relative overflow-hidden bg-gradient-to-br from-[#433A9B] to-[#5a4fb8] p-8 text-white">
      <div className="absolute right-0 top-0 -mr-32 -mt-32 h-64 w-64 rounded-full bg-white/10" />
      <div className="absolute bottom-0 left-0 -mb-24 -ml-24 h-48 w-48 rounded-full bg-[#F39A3D]/20" />

      <div className="relative z-10">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="mb-3 flex items-center gap-2">
              <Activity className="h-6 w-6 text-[#F3D33B]" />
            ...
            <div className="flex gap-4">
              <Button
                ...
                className="bg-[#F39A3D] text-white hover:bg-[#F39A3D]/90"
              >
              ...
              <Button
                ...
                className="bg-white text-[#433A9B] hover:bg-white/90"
              >
          ...
          <div className="ml-8 hidden lg:block">
            <div className="relative h-48 w-48">
              <div className="absolute inset-0 animate-pulse rounded-full bg-[#F39A3D]/20" />
              <div className="delay-75 absolute inset-4 animate-pulse rounded-full bg-[#F3D33B]/20" />
