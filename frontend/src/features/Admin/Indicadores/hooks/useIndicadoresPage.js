...
export const kpiDefinitions = [
  ...
  { key: "produccion_dia", label: "Unidades del Dia", color: "#F39A3D" },
  { key: "porcentaje_defectos", label: "Tasa de Defectos", color: "#dc2626", sufijo: "%" },
  { key: "cumplimiento_meta", label: "Cumplimiento de Meta", color: "#0891b2", sufijo: "%" },
];

export function useIndicadoresPage() {
